...
- Sidebar sections redesign: [`SPECs/sidebar-sections-spec.md`](SPECs/sidebar-sections-spec.md) — split the sidebar into Pinned, Recents, and Everything; keep the existing file tree under Everything; add per-workspace pinned files and metadata-backed recent files with Show More pagination.
